...
embed_audio("https://traffic.libsyn.com/audiblebleeding/Exam_Prep_2023_-_Hemodialysisau.mp3")
...
Check out [our episode on the history of AV Access](https://www.audiblebleeding.com/2022/03/24/vascular-origin-stories-holding-pressure-history-of-hemodialysis-access/) where we interview Dr. Kenneth Appell, one of the surgeons who pioneered this surgical technique.
:::
...
Overall AVG have benefit of earlier cannulation, however they have lower patency rates and higher infection rates. There is no difference between grafts and fistulas for perioperative morbidity and mortality.[@macsata2019]
...
Check out [our episode on the basics of AV Access placement](https://www.audiblebleeding.com/2022/03/22/holding-pressure-case-prep-arteriovenous-fistula-graft-creation/).
:::
...
Due to underlying comorbidities, it is often best to avoid general anesthesia in these patients. Many access procedures can be performed under regional or straight local anesthetic. There, it is very important to understand the pharmacokinetics and maximum doses of common local anesthetics.[@neal2018] Historically, it has been taught that the inclusion of epinephrine allows for higher dosages, but more recent reports do not include this adjustment.[@sztajnkrycer2019] Common local anesthetics include:
...
[MedCalc has a useful calculator for estimating maximum allowable volume of anesthetic based on patient weight and dose percentage.](https://www.mdcalc.com/calc/10205/local-anesthetic-dosing-calculator)
:::
...
Patients with acute pain and loss of pulses immediately after AVF creation should first have arterial injury/thrombosis ruled out, but then after diagnosed with steal syndrome should undergo fistula ligation.[@schanzer2004; @yevzlin2016]
