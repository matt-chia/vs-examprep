...
+==================+===================+===================+
| **Transa         | Cosmetically more | Difficult to      |
| xillary**        | appealing as it   | visualize the     |
|                  | has a limited     | anatomy,          |
|                  | hidden scar       | dependent on good |
|                  |                   | assistance        |
|                  |                   |                   |
|                  |                   | Risk of injury to |
|                  |                   | T1 nerve root,    |
...
|                  |                   | vein.             |
+------------------+-------------------+-------------------+
| -   \*Supracla   | Good for scalene  | Unable to         |
|                  | triangle access   | decompress venous |
|     vicular\*\*  | and debulking and | compression or    |
|                  | cervical rib      | visualize vein    |
|                  | resection         | adequately        |
|                  |                   |                   |
|                  | Required for aTOS | Cosmetically less |
|                  | if arterial       | appealing         |
|                  | reconstruction    |                   |
|                  | necessary         |                   |
+------------------+-------------------+-------------------+
| -   \*Infracla   | Good access for   | Unable to expose  |
|                  | venous            | subclavian artery |
|     vicular\*\*  | decompression     | or decompress     |
|                  |                   | brachial plexus.  |
|                  | Allows for        |                   |
|                  | excision of       | Difficult to      |
|                  | subclavius muscle | access most       |
|                  | and               | posterior aspect  |
|                  | costoclavicular   | of rib            |
|                  | ligament          |                   |
|                  |                   | Cosmetically less |
|                  |                   | appealing         |
+------------------+-------------------+-------------------+
| **Paracla        | Useful if mixed   | Requires two      |
| vicular**        | etiology TOS to   | incisions one     |
|                  | adequately        | above and below   |
|                  | decompression all | the clavicle      |
|                  | neurovascular     |                   |
|                  | structures        |                   |
+------------------+-------------------+-------------------+
...
-   **Paget Schroetter Syndrome**
    ...
    -   First defined by Hughes in 1949 in reference to Sir James Paget
        ...
        axillary vein thrombosis. [@humphries123ThoracicOutlet2019]
...
abduction and external rotation.[@moriarty2015]
...
-   Surgical treatment of severe resistant subclavian vein stenosis in
    ...
    vein patch plasty. [@melbyComprehensiveSurgicalManagement2008]
